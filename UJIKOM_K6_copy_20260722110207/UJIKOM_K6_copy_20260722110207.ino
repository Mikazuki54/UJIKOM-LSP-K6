#include <Arduino.h>
#include <WiFi.h>
// Baris #include <LittleFS.h> telah dihapus
...
const char* thingSpeakApiKey = "B7F4IWU7AHLWAPCI"; // Ganti dengan API Key ThingSpeak
const char* thingSpeakUrl = "http://api.thingspeak.com/update";
const unsigned long channelID = 3433062;
...
void setup() {
  ...
  // Blok kode mount LittleFS telah dihapus dari sini
  ...
  // Menambahkan Header CORS agar file HTML di komputer lokal diizinkan mengakses ESP32
  DefaultHeaders::Instance().addHeader("Access-Control-Allow-Origin", "*");
  DefaultHeaders::Instance().addHeader("Access-Control-Allow-Methods", "GET, POST, PUT");
  DefaultHeaders::Instance().addHeader("Access-Control-Allow-Headers", "Content-Type");

  // Baris server.serveStatic() untuk LittleFS telah dihapus
